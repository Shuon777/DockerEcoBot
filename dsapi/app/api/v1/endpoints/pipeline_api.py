...
router = APIRouter()
pipeline = IntegratedDynamicPipeline(bot_client=EcobotHttpClient(domain=settings.BOT_DOMAIN),
                                         generator=SimpleGenerator(),
                                         template_repo=ExcelTemplateRepository(settings.PATH_TEMPLATES_EXCEL))
