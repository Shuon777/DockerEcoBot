...
MODEL_DIMENSIONS = {
    ...
    "DiTy/cross-encoder-russian-msmarco": 768
}
...
class EmbeddingConfig:
    def __init__(self):
        ...
        self.MODEL_PATHS = {
            ...
            "BAAI/bge-reranker-v2-m3": os.path.join(self.BASE_MODELS_DIR, "rerankers", "bge-reranker-v2-m3"),
            "DiTy/cross-encoder-russian-msmarco": os.path.join(self.BASE_MODELS_DIR, "rerankers", "DiTy_cross-encoder-russian-msmarco")
        }
