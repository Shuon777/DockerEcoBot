...
import geoalchemy2
from sqlalchemy import Boolean, Column, Integer, String, Text, JSON, ForeignKey, Date, DateTime, Table, UniqueConstraint
...
object_name_synonym_link = Table(
    ...
    Column('priority', Integer, default=0, doc='Приоритет отображения (1 = самый высокий)'), # <-- ДОБАВЛЕНО
