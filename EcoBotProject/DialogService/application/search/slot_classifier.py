...
Для "Географический объект":
  "Подтип объекта": категория объекта — одно из: Музей, Заповедник, Заказник, Нацпарк,
    ...
    Примеры:
      ...
      "Музеи в Иркутске" → "Подтип объекта"="Музей" + "Детальное расположение"="Иркутск"
      "Музеи в Бодайбо" → "Подтип объекта"="Музей" + "Детальное расположение"="Бодайбо"
