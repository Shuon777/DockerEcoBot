...
Прилагательное НЕ является частью имени если пространственный объект упомянут отдельно:
  "омуль в Байкале" → synonym="омуль" + baikal_relation="в/на Байкале"
  "животные на Байкале" → synonym=null + baikal_relation="в/на Байкале"
...
Для "Объект флоры и фауны":
  ...
  "baikal_relation": ["в/на Байкале", "рядом/около Байкала", "неизвестно"]
    ...
    Примеры:
      ...
      "байкальский омуль" → synonym="байкальский омуль", baikal_relation НЕ заполнять ("байкальский" — часть имени)
      "байкальская нерпа на Байкале" → synonym="байкальская нерпа" + baikal_relation="в/на Байкале" (Байкал упомянут отдельно)
