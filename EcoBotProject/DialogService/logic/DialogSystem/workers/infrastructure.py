...
class InfrastructureWorker:
    ...
    async def analyze(self, query: str) -> tuple[InfraAnalysis, str]:
        ...
        ВАЖНЫЕ ПРАВИЛА:
        1. Общие объекты в запросе: "природоохранные территории", "музеи", "памятники" могут указываться в поле object_name, если являются объектом запроса.
        ...
        Ответь ТОЛЬКО JSON: {{"action": "describe/show_map/list_items/count_items или null", "object_name": "название или null", "entity_type": "Infrastructure/GeoPlace/Service/Unknown", "category": "Природный объект/Достопримечательности/Unknown", "subcategory": [], "area_name": "место или null"}}
        """
