...
class BiologyWorker:
    ...
    async def analyze(self, query: str) -> tuple[BiologyAnalysis, str]:
        ...
        Ответь ТОЛЬКО JSON: {{"action": "describe/show_image/show_map/list_items/find_nearby или null", "species_name": "название или null", "category": "Flora/Fauna/Unknown или null", "location_context": "место или null"}}
        """
