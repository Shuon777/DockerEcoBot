...
from logic.config_rasa import API_URLS, DEFAULT_TIMEOUT, GIGACHAT_TIMEOUT, GIGACHAT_FALLBACK_URL, PUBLIC_BASE_URL
...
class ActionShowBBW(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        buttons = [[{"text": "📝 Перейти на подробную статью", "url": f"{PUBLIC_BASE_URL}/maps/location/BBW/index.html"}]]
