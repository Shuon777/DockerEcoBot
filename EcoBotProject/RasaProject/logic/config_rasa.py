...
GIGACHAT_FALLBACK_URL = get_env_var("GIGACHAT_FALLBACK_URL", "http://gigachat:5556/ask_simple")

# --- Backend EcoBot API ---
ECOBOT_API_BASE_URL = get_env_var("ECOBOT_API_BASE_URL", "http://backend:5555")

# --- Публичный домен (для ссылок пользователям) ---
PUBLIC_BASE_URL = get_env_var("PUBLIC_BASE_URL", "https://testecobot.ru")
